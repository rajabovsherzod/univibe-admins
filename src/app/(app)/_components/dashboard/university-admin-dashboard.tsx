...
function ComingSoon() {
  return (
    <div className="rounded-2xl border border-border-secondary bg-bg-primary overflow-hidden">
      <div className="flex flex-col items-center justify-center py-24 px-6 text-center">
        ...
        <h2 className="text-lg font-bold text-fg-primary mb-2">Tez orada</h2>
