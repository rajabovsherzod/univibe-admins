  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-6 px-4 text-center">
      ...
      <div className="space-y-1.5">
        <h2 className="text-xl font-bold text-primary">Xatolik yuz berdi</h2>
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="rounded-xl border border-secondary bg-primary px-5 py-2.5 text-sm font-semibold text-primary hover:bg-secondary transition-colors"
        >
          Dashboard
        </button>
      </div>
