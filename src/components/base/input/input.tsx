  ...
  return (
    <AriaGroup
      ...
      className={({ isFocusWithin, isDisabled, isInvalid }) =>
        cx(
          // ✅ base
          "relative flex w-full flex-row place-content-center place-items-center rounded-lg bg-primary shadow-xs",
          "ring-1 ring-primary ring-inset transition-shadow duration-100 ease-linear",
          ...
          // ✅ focus = brand (xuddi search input)
          isFocusWithin && !isDisabled && !isInvalid && "ring-2 ring-brand",
